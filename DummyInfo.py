...
def main():
    ...
    userInfo = [("fqrqwqy", "0verth3rqinb0w", "kansasgirl@gmail.com", "Dorothy Gale", "202-918-2132", 40293, "4042 Nowear Lane", "Fields", "KS", "United States", 3589481030276534, "2024-12-" + str(monthLengths(12, 2024)), 112549572, 72254548),
                ...
                ("Kira1966", "BitesTheDust", "kirayoshikage@aol.com", "Kira Yoshikage", "318-659-6412", 77200, "4156 Villa Road", "Morioh", "", "Japan", 341179894763895, "2025-02-" + str(monthLengths(2, 2025)), 556649355, 31090784),
                ("NotAScammer", "businessmogel", "workingfromhome@gmail.com", "Bernie Madoff", "309-611-6048", 82985, "12345 Main Street", "New York City", "NY", "United States", 5198066549559914, "2024-09-" + str(monthLengths(9, 2024)), 358769721, 51162661),
                ...
                ("FirstConsul", "AverageHeightForTheTime", "nbonaparte@yahoo.com", "Napoleon Bonaparte", "582-333-0707", 85947, "4154 Fraternity Street", "Paris", "", "France", 6011352349624030, "2026-01-" + str(monthLengths(1, 2026)), 940650316, 31487884),
                ("clopez", "asdfasdf", "lopez@gmail.com", "Carlos Lopez", "121-123-1234", 64123, "This is the St.", "Kansas City", "MO", "US", 1234234534564567, "2026-01-" + str(monthLengths(1, 2026)), 123456789, 12345678),
                ("kwhite", "asdfasdf", "white@gmail.com", "Katie White", "456-567-7890", 64123, "this is the St.", "Kansas City", "MO", "US", 1111222233334444, "2025-03-" + str(monthLengths(3, 2025)), 598765432, 87654321),
                ("JackMan", "asdfasdf", "Jlopez@gmail.com", "Jack Lopez", "736-204-7295", 64123, "This is the St.", "Kansas City", "MO", "US", 1234789364091263, "2024-06-" + str(monthLengths(6, 2024)), 183609257, 16849206),
                ("LastConsul", "AcrosstheRhine", "venividivici@outlook.com", "Julius Caesar", "213-708-6937", 61422, "415 SPQR Street", "Rome", "", "Italy", 5456454184555214, "2026-09-" + str(monthLengths(9, 2026)), 663143155, 36846023)]
    ...
    FundInfo = [("kansasgirl@gmail.com", "Journey Home", "Dorothy wants to get off the Wizard's Wild Ride and get back home to Kansas.", "Travel", "PowerfulReasons_hero.jpeg", 1500, "2022-04-16 10-31-22", "2022-10-1 23-59-59"),
                ...
                ("lopez@gmail.com", "Tech Start Up", "Please fund my new start up, i'm making something like GoFundMe, but its not GoFundMe...", "Business", "32899395526_bf271c8fa9_b.jpeg", 10000, "2022-10-31 10-00-00", "2025-12-31 23-59-59"),
